      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
        ...
        >
          {stats.map((stat, idx) => (
            ...
            >
              <div className="w-10 h-10 mx-auto mb-3 rounded-full bg-[#6B46C1]/10 flex items-center justify-center text-[#6B46C1]">
                {stat.icon}
              </div>
        ...
        >
          {benefits.map((benefit, idx) => (
            ...
            >
              ...
              <h3 className="text-lg sm:text-xl font-black text-black mb-2 font-['Montserrat'] group-hover:text-[#6B46C1] transition-colors">
                {benefit.title}
              </h3>
